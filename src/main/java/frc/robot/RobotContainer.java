...
public class RobotContainer {
  ...
  public RobotContainer() {
    switch (Constants.currentMode) {
      case REAL:
        ...
        vision = new Vision(
            drive::addVisionMeasurement, drive::getRotationAtTime, drive::getPose,
      ...
      default:
        ...
        vision = new Vision(drive::addVisionMeasurement, drive::getRotationAtTime, drive::getPose,
            new VisionIO() {
        }, new VisionIO() {
        });
    ...
    autoChooser.addOption("Bump Depot Straight Climb", new SequentialCommandGroup(
        AutoBuilder.buildAuto("Bump Straight Depot Climb"),
        new AutoClimbL1Command(drive, climber, turret, intake)));
  ...
  public void teleopInit() {
    ...
    CommandScheduler.getInstance().schedule(new HomeClimberCommand(climber, turret));
  }
